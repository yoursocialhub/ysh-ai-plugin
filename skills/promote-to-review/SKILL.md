...
3. `get_idea(id)` on each candidate. Report what it carries: caption, notes, media count, planned date. Call out anything thin — an empty caption or no media is worth flagging before it reaches a reviewer.
